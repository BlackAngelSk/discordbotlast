        ...
        case 'music':
            embed.setTitle('🎵 Music Commands')
                ...
                .addFields(
                    ...
                    { name: '📝 Info & Playlists', value: `\`${p}lyrics [song]\` - Get song lyrics\n\`/playlist create name:<name> [description]\` - Create playlist\n\`/playlist add playlist:<name> song:<query/url>\` - Add song\n\`/playlist remove playlist:<name> song_number:<n>\` - Remove song\n\`/playlist list\` - Show your playlists\n\`/playlist load playlist:<name>\` - Queue playlist\n\`/playlist public playlist:<name>\` - Publish playlist\n\`/playlist browse\` - Browse public playlists\n\`/playlist recommend\` - Get recommendations\n\`/playlist delete playlist:<name>\` - Delete playlist` },
