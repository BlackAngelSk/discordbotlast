...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            console.error('Error in weather slash command:', error);
            if (!interaction.replied && !interaction.deferred) {
                await interaction.reply({ content: '❌ An error occurred while using the weather command!', flags: MessageFlags.Ephemeral });
            } else {
                await interaction.editReply({ content: '❌ An error occurred while using the weather command!' });
            }
        }
    },
};