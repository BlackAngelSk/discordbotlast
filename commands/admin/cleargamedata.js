    ...
    async execute(message, args) {
        try {
            ...
            if (user) {
                ...
                gameStatsManager.data.stats[key] = {
                    blackjack: { wins: 0, losses: 0, ties: 0 },
                    roulette: { wins: 0, losses: 0, earnings: 0 },
                ...
                const keysToReset = Object.keys(gameStatsManager.data.stats)
                ...
                const embed = new EmbedBuilder()
                    .setColor(0xed4245)
                    .setTitle('🎮 Game Data Cleared')
                    .setDescription(`Game statistics for **${keysToReset.length}** users have been reset!`)
                    .setTimestamp();
